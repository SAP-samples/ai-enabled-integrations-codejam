...
> [!NOTE]
> If you want to check out the service under the hood, the CAP service is available in the `apps/altura-service-locator` folder.
...
| Property | Value |
|----------|-------|
| Name | AI-integrations-agent-000 |
| Short Text | AI-integrations user 000 agent |
