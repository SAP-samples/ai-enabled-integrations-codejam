...
<details>
<summary>If you are completing the content outside of a CodeJam event ->  <i>Expand this section</i> ⏬️</summary>

<blockquote>
<br/>

You can use an [SAP BTP Trial account](https://www.sap.com/products/technology-platform/trial.html) and set up SAP Integration Suite there to complete part of the CodeJam content on your own. You will not be able to complete exercises 1 to 3 but it is possible to complete the exercises that explore the MCP capabilities.
